...
@app.route('/lf2/blog')
def lf2_blog():
	complete_html_content = post_renderer.render_posts_from(static_file_path('static/markdown/lf2/blog/'))
	return render_template('lf2_blog.j2', title='LF2 Blog', content=complete_html_content)

@app.route('/lf2/intro')
def lf2_intro():
	complete_html_content = post_renderer.render_posts_from(static_file_path('static/markdown/lf2/intro/'))
	return render_template('lf2_blog.j2', title='Little Fighter 2', content=complete_html_content)

@app.route('/chinese/blog')
def mandarin_blog():
	complete_html_content = post_renderer.render_posts_from(static_file_path('static/markdown/chinese/blog/'))
